...
/**
 * Returns student records with optional search and filters.
...
/**
 * Returns dashboard totals and course distribution.
 ...
 */
export const getRecentStudents = async (params?: GetRecentStudentsParams, options?: Parameters<typeof customFetch>[1]): Promise<Student[]> => {

  return customFetch<Student[]>(getGetRecentStudentsUrl(params),
  {
    ...options,
    method: 'GET'
